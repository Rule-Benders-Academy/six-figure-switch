...
// Longer, more detailed fake-but-credible student reviews
const REVIEWS: { quote: string; name: string; role: string }[] = [
  {
    quote:
      "I went from guessing to a simple weekly plan I could follow. In week 7 I signed a £900 per day contract and the client said my offer felt clear and low risk. The cadence made it easy to keep momentum instead of rewriting my CV for the tenth time.",
    name: "Sam Richards",
    role: "Product Manager",
  },
  {
    quote:
      "I booked 6 calls in under 3 weeks using the outreach scripts and a focused ICP. One turned into a paid discovery and that rolled into a contract in 38 days. The system gave me language to explain value without sounding fluffy or needy.",
    name: "Leah Khan",
    role: "Business Analyst",
  },
  {
    quote:
      "Packaging outcomes instead of tasks changed the conversation. I raised my rate from £450 to £950 and the client accepted on the call. The numbers file helped me anchor the price and defend it with calm confidence.",
    name: "Jonathan Grant",
    role: "Consultant",
  },
  {
  ...
  {
    quote:
      "The offer workbook forced me to make choices. Once the positioning clicked, the conversations got easier. I closed a £6,000 sprint and used it to build the flagship case study that keeps paying dividends.",
    name: "Priya Singh",
    role: "Change Manager",
  },
  {
  ...
  {
    quote:
      "The case study template is gold. It gave me a simple way to talk about a messy project with clear before and after. I landed a retainer in 6 weeks and finally stopped sending random applications.",
    name: "Ava Lewis",
  ...
  {
    quote:
      "The pipeline tracker killed my avoidance. I did the work, measured it, and watched the numbers move. Five quality conversations in 3 weeks turned into a contract at £1,050 per day.",
    name: "Tom Hughes",
    role: "Data Consultant",
  },
  {
    quote:
      "Interview prep gave me a clean story with proof points. The client said yes on the call, then asked if I could start Monday. I signed at £900 per day for 8 weeks and negotiated a review after week 4.",
    name: "Sarah Bell",
    role: "Transformation Lead",
  },
  {
    quote:
      "I swapped task lists for outcomes and everything got easier. My day rate moved from £400 to £820 on the next opportunity because I framed the problem and the path instead of listing tools.",
    name: "Daniel Murphy",
    role: "PMO Consultant",
  },
  {
    quote:
      "Twenty thoughtful messages, six replies, two meetings, one contract at £1,200 per day. No spam, no begging, just clear value and a simple call structure I could follow without scripts in front of me.",
    name: "Olivia Carter",
  ...
  {
    quote:
      "The plan is practical and specific. I knew exactly what to do each week. In month two I closed an £18k project and used it to produce a strong reference and a clean case study.",
    name: "Maya Patel",
  ...
  {
    quote:
      "Offer clarity changed everything. I went from a generic CV to a sharp value proposition in a week. Signed £1,050 per day and the client asked for a second stream before week 3.",
    name: "Hannah Cole",
    role: "Programme Lead",
  },
  {
    quote:
      "Seven replies from twenty five notes because the message finally sounded like me and solved a real problem. One closed at £900 per day with zero haggling because my anchor made sense.",
    name: "Vikram Shah",
    role: "Delivery Manager",
  },
  {
    quote:
      "I stopped waiting for recruiters and built a simple outbound habit. That habit turned into a 10 week piece at £800 per day and a referral I would have never seen on a job board.",
    name: "Tara O'Neill",
  ...
  {
    quote:
      "Warm intros beat cold platforms every time. One coffee chat turned into £950 per day for 10 weeks because I had a tight story and a simple next step.",
    name: "Peter Novak",
  ...
  {
    quote:
      "The value map turned a complex project into a story a sponsor could grasp in 3 minutes. They called it a no brainer and signed the SOW within a day.",
    name: "Grace Miller",
    role: "Portfolio Manager",
  },
  {
    quote:
      "I stopped underselling. Framed outcomes, not tasks, and moved from £500 to £950 per day. The call felt natural and I left with clear next steps instead of hope.",
    name: "Noah Bennett",
    role: "Scrum Master",
  },
  {
    quote:
      "The numbers gave me the words to defend my rate without getting defensive. The client accepted and said the structure made budget approvals easier.",
    name: "Ibrahim Ali",
    role: "Technical PM",
  },
  {
  ...
  {
    quote:
      "Interview prep helped me own the room. I opened with a point of view, asked better questions, and shaped scope. That led to an £18k discovery and a longer runway.",
    name: "Jack Cooper",
...
function ReviewCard({
  ...
  return (
    <figure className="w-[680px] sm:w-[760px] shrink-0 rounded-3xl border border-neutral-200 bg-white p-8 sm:p-10 shadow-sm">
      <Stars />
      <blockquote className="text-lg sm:text-xl leading-relaxed text-neutral-800">
        “{quote}”
      </blockquote>
...
function MarqueeRow({
  reversed = false,
  speed = 200, // slower for larger cards
  offset = 0,
}: {
  reversed?: boolean;
  ...
  // Duplicate once to create a seamless loop with -50% translate
...
const StudentReviewsMarquee: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Marquee rows, full width, no horizontal scroll */}
      <div className="mt-10 w-full overflow-x-hidden">
        <div className="space-y-12">
          <MarqueeRow reversed={false} speed={200} offset={0} />
          <MarqueeRow reversed={true} speed={260} offset={30} />
        </div>
      </div>
