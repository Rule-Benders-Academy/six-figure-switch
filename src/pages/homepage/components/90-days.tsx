      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-14 sm:py-16 lg:py-20">
        <div className="grid grid-cols-1 gap-10 lg:gap-14">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <a
              href="/checkout"
              className="mt-6 inline-flex items-center justify-center rounded-xl bg-neutral-900 px-6 py-3 text-base sm:text-lg font-semibold text-white shadow-sm hover:bg-neutral-800 focus:outline-none focus:ring-2 focus:ring-neutral-400"
            >
