    ...
    <div className="min-h-screen !font-jakarta">
      ...
      <section className="relative bg-black text-white pb-5 md:pb-8 lg:pb-12 pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-24 overflow-hidden min-h-[calc(100vh-24px)] md:min-h-[calc(100vh-56px)]">
        ...
        <div className="relative max-w-[95%] mx-auto text-center mt-8 md:mt-10 lg:mt-16">
          <p className="text-2xl md:text-4xl lg:text-5xl lg:leading-[100%] mb-8 md:mb-9 lg:mb-10">
            If you are an employed professional,<br />
            thinking there must be more to life than this,
            <br />
            <span className="text-[#FFA500] font-bold underline">you’re in the right place.</span>
          </p>

          <p className="text-2xl md:text-4xl lg:text-5xl lg:leading-[100%]">
            Did you know that you could be earning<br />
            <span className="text-[#FFA500] font-bold underline">3 x more money</span> for exactly the same skill set you already have?
          </p>

          <div className="relative border border-[#3C3C3C] bg-[#FFFFFF12] rounded-3xl md:rounded-[35px] lg:rounded-[50px] mt-7 md:mt-9 lg:mt-10 py-7 md:py-[80px] lg:py-20">
            <div className=" px-4 sm:px-6 md:px-10" >
              <p className="text-2xl md:text-[40px] lg:text-[44px]">It’s time to become an</p>
              <h2 className="text-[34px] md:text-5xl lg:text-[65px] leading-tight lg:leading-[100%] font-extrabold tracking-wide uppercase mt-5">
                Independent Consultant
              </h2>
              <hr className="h-[6px] w-[90%] mx-auto mt-8 bg-white" />

              <p className="text-xl md:text-4xl lg:text-[48px] lg:leading-[100%] mt-12 w-[80%] mx-auto">
                From there, you could be on the path to earning
                <span className="text-[#FFA500] font-bold underline"> $1,500/day (and more)</span> while choosing when you work and when you don’t.
              </p>
            </div>
            <div className=" absolute top-0 left-0 w-full h-full border border-[#3C3C3C] bg-[#FFFFFF14] rounded-md z-[-1]" style={{
              filter: "blur(24px)"
            }}></div>
          </div>

          <div className="flex justify-center pt-4 lg:mt-12 md:mt-10 mt-4">
            <Image src={downArrow} alt="" className="w-[34px] md:w-16 lg:w-[84px] h-[34px] md:h-16 lg:h-[84px]" />
          </div>
        </div>
      </section>
      <div className="bg-gradient-to-b from-[#141314] to-[#272526] h-full">
            ...
            <div key={index} className="">
              <div className="flex items-center gap-4 md:gap-8">
                <div className=" shrink-0">
                  <Image src={CancelIcon} alt="" className="lg:w-[74px] md:w-12 w-11" />
                </div>
        ...
        <section className="relative text-white px-4 sm:px-8 md:px-16 lg:px-24 md:py-16 bg-gradient-to-b from-[#141314] to-[#272526] pb-10">
          <div className="max-w-[75%] md:max-w-[35%] 2xl:max-w-[50%] mx-auto text-center z-10  transform translate-y-[15px] sm:hidden">
            <p className="text-2xl md:text-2xl lg:text-3xl xl:text-5xl">
              You’re not under qualified. You’re<br /> under positioned.
            </p>
          ...
          <div className="flex justify-between z-10 relative -mb-20 items-end max-w-[95%] mx-auto gap-5">
            <Image src={Person1} alt="Person 1" className="lg:h-[306px] md:h-[250px] h-[136px] lg:w-[224px] md:w-[180px] w-[101px] rounded-md md:shadow-[19.17px_73.89px_58.2px_0px_rgba(0,0,0,0.8)] shadow-[6.17px_23.79px_58.2px_0px_rgba(0,0,0,0.8)]" />
            ...
            <Image src={Person3} alt="Person 2" className="lg:h-[296.02px] md:h-[220px] h-[130px]  lg:w-[216.32px] md:w-[160px] w-[88px] rounded-md -mt-10 md:-mt-20 md:shadow-[-19.17px_73.89px_58.2px_0px_rgba(0,0,0,0.8)] shadow-[-6.17px_23.79px_58.2px_0px_rgba(0,0,0,0.8)]" />
          </div>
          ...
          <div className="flex justify-between relative -mt-20 z-10  max-w-[95%] mx-auto">
            <Image src={Person2} alt="Person 3" className="lg:h-[311px] md:h-[260px] h-[130px] lg:w-[260px] md:w-[200px] w-[100px] rounded-md md:shadow-[19.17px_-31.89px_58.2px_0px_rgba(0,0,0,0.8)] shadow-[6.17px_-10.89px_58.2px_0px_rgba(0,0,0,0.8)]" />
            <Image src={Person4} alt="Person 4" className="lg:h-[328px] md:h-[240px] h-[117px] lg:w-[296px] md:w-[200px] w-[99px] rounded-md md:shadow-[-19.17px_-41.89px_58.2px_0px_rgba(0,0,0,0.8)] shadow-[-6.17px_-13.89px_58.2px_0px_rgba(0,0,0,0.8)]" />
          </div>
        ...
        <div className="px-4 sm:px-8 md:px-16 lg:px-24 flex flex-col items-center">
          ...
          <div className="lg:max-h-[649px] lg:h-[64vh] md:h-[400px] h-[234px] bg-[#C8C8C8] w-full rounded-[17.09px] md:rounded-[35px] lg:rounded-[47.42px] mt-6 md:mt-8 lg:mt-12">
          </div>
          <GradientButton>
            I’m in – lets Go!
          </GradientButton>
        ...
        <TestimonialSection
          ...
          description={
            <>
              Left his struggling online business. First consulting role at £400/day. Multiple government contracts since.
            </>
          }
        ...
        <TestimonialSection
          ...
          description={
            <>
              Turned mid-career stagnation into £900/day independence
              and freedom.Turned mid-career stagnation into £900/day independence
              and freedom.
            </>
          }
