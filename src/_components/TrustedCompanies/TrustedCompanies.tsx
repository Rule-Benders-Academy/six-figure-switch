  ...
  return (
    <section className="bg-[linear-gradient(to_bottom,#141314,#272526)] text-white pt-4 md:pt-14 lg:pt-20 pb-12 md:pb-16 lg:pb-20 text-center overflow-hidden">
      ...
      <Marquee speed={60} gradient={false} pauseOnHover={true} className="px-3 md:px-4" autoFill={true}>
        <div className="flex items-center justify-center h-[38px] md:h-[80px] lg:h-[101px] w-[65px] md:w-[140px] lg:w-[175px] !mx-5 md:!mx-10">
          <Image src={Logo1} alt="logo-1" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[38px] md:h-[80px] lg:h-[101px] w-[65px] md:w-[140px] lg:w-[170px] !mx-5 md:!mx-10">
          <Image src={Logo2} alt="logo-2" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[38px] md:h-[70px] lg:h-[90px] w-[40px] md:w-[60px] lg:w-[90px] !mx-5 md:!mx-10">
          <Image src={Logo3} alt="logo-3" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[38px] md:h-[50px] lg:h-[101px] w-[40px] md:w-[80px] lg:w-[109.32px] !mx-5 md:!mx-10">
          <Image src={Logo4} alt="logo-4" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[38px] md:h-[70px] lg:h-[101px] w-[54px] md:w-[100px] lg:w-[144.46px] !mx-5 md:!mx-10">
          <Image src={Logo5} alt="logo-5" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[38px] md:h-[60px] lg:h-[101px] w-[40px] md:w-[80px] lg:w-[123px] !mx-5 md:!mx-10">
          <Image src={Logo6} alt="logo-6" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[38px] md:h-[90px] lg:h-[118.44px] w-[80px] md:w-[150px] lg:w-[241.78px] !mx-5 md:!mx-10">
          <Image src={Logo7} alt="logo-7" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[11px] md:h-[25px] lg:h-[33.76px] w-[38.38px] md:w-[70px] lg:w-[114.77px] !mx-5 md:!mx-10">
          <Image src={Logo8} alt="logo-8" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[11.22px] md:h-[30px] lg:h-[33.76px] w-[60px] md:w-[120px] lg:w-[180.27px] !mx-5 md:!mx-10">
          <Image src={Logo9} alt="logo-9" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[31.87px] md:h-[60px] lg:h-[95.31px] w-[53.81px] md:w-[100px] lg:w-[160.9px] !mx-5 md:!mx-10">
          <Image src={Logo10} alt="logo-10" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[30.55] md:h-[60px] lg:h-[91.35px] w-[32.5px] md:w-[70px] lg:w-[97.19px] !mx-5 md:!mx-10">
          <Image src={Logo11} alt="logo-11" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[29.22px] md:h-[60px] lg:h-[87.38px] w-[75.44px] md:w-[120px] lg:w-[225.59px] !mx-5 md:!mx-10">
          <Image src={Logo12} alt="logo-12" className="w-full h-full" />
        </div>
        <div className="flex items-center justify-center h-[38.52px] md:h-[70px] lg:h-[100.38px] w-[49.15px] md:w-[80px] lg:w-[125.59px] !mx-5 md:!mx-10">
