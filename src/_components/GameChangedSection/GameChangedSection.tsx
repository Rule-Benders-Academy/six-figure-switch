...
// ADD: localized price components
import PriceRange from "../../_components/PriceRange/PriceRangeComponent";
      ...
      <div className="text-center space-y-6 relative">
        <div className="bg-gradient-to-b from-[#434040] to-[#000000] pt-8 md:py-20 pb-20 md:pb-40 md:mb-32 relative">
          <div className="relative z-10">
            <h1 className="text-2xl md:text-5xl lg:text-[44px] font-medium">
        ...
        <div className="relative z-10 -top-14 md:-top-48 lg:text-[24px] space-y-5 md:space-y-8 lg:space-y-12 w-[80%] lg:w-[55%] mx-auto">
          <p>
            ...
            <br /> the job market has flipped.
          </p>

          <p>
            Permanent roles now show the{" "}
            <span className="text-[#FFA500]">slowest income growth</span>—just
            12% over five years.
          </p>

          <p className="text-[#FFA500]">
            But independent consultants? <br />
            They&#39;ve seen their income grow by{" "}
            <span className="text-[#FFA500] font-bold">60% to 150%.</span>
          </p>

          <p>
            Employers are shifting too. <br />
            Over 40% of companies now prefer contract-based talent for key
            projects <br />
          ...
          {/* UPDATED: localized price range */}
          <p>
            Right now, early movers are landing{" "}
            <PriceRange minUsd={700} maxUsd={1400} /> per day. But in 2026, this
            window will start to close as AI and global competition make it
            harder to get in.
          </p>
