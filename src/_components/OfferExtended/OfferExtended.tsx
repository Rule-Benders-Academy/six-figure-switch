...
const OfferExtended: React.FC<OfferExtendedProps> = ({ initialDays }) => {
  ...
  return (
    <div className="mx-auto w-[90%] lg:w-[55%] bg-white bg-opacity-[0.08] -mt-10 rounded-[16px] md:rounded-[30px] lg:rounded-[42.36px] p-3 md:p-6 text-white lg:max-w-[80%] md:max-w-[60%] text-center border border-neutral-700 py-2 md:py-8 shadow-[10.11px_15.64px_22.64px_rgba(0,0,0,0.5)] md:shadow-[18.11px_22.64px_22.64px_rgba(0,0,0,0.5)]">
