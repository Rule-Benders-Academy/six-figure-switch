      ...
      <div className="">
        <div className="bg-gradient-to-b from-[#434040] to-[#000000] py-8 md:py-10 lg:py-16 relative px-4 sm:px-8 md:px-16 lg:px-24">
          <div className="relative z-10 pb-32">
            <h1 className="text-2xl md:text-5xl lg:text-[44px] leading-tight font-medium max-w-[369px] md:max-w-[728px] mx-auto">
              We are so confident
              <br />
        ...
        <div className="relative z-10">
          <div
            className="absolute -top-[140px] left-0 z-[1] w-full h-[200px]"
            style={{
