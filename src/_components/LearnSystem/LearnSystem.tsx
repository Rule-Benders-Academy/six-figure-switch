  ...
  return (
    ...
    >
      <div className="max-w-[442px] lg:max-w-[942px] mx-auto">
        ...
        <p className="bg-gradient-to-r from-[#FFBE48] via-[#FFA500] to-[#E99803] text-transparent bg-clip-text text-2xl md:text-4xl lg:text-[44px] leading-tight lg:leading-[100%] font-semibold mb-3 md:mb-6 lg:mb-10">
          ...
          <span className="underline decoration-[#FFA500]">
            work with our tried and tested
            <br /> system taught by a world leading <br />
            Consultant.
          </span>
        </p>

        <GradientButton className="!text-sm md:!text-2xl lg:!text-[24px] !py-3 md:!py-[16px] lg:!py-[26px] !px-4 md:!px-8 lg:!px-[48px] max-w-[186px] md:max-w-[515px]">
          START TODAY
        </GradientButton>
      </div>
    </section>
