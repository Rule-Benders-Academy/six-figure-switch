  ...
  return (
    <section className="text-white lg:mt-32 md:mt-16 mt-11">
      <div className="flex flex-col md:flex-row items-start gap-2 md:gap-10 lg:gap-24 mb-7 lg:mb-12">
        ...
        <div className="lg:w-[533px] md:w-[300px] w-[210px] rounded-full mx-auto md:mx-0 overflow-hidden flex-shrink-0">
      ...
      <div className="mx-auto bg-[#373536] pt-5 pb-8 md:py-7 lg:py-8 border-[1px] border-[#595758] rounded-2xl md:rounded-3xl lg:rounded-[36px] shadow-[18.11px_22.64px_22.64px_rgba(0,0,0,0.5)] xl:max-w-[1247px]">
        ...
        <div className="flex justify-center flex-wrap gap-6">
          {achievements.map((item, index) => (
            <div
              key={index}
              className={`flex flex-col items-center text-center md:px-4 w-[40%] md:w-[190px] lg:w-[240px] ${index === 0 && 'hidden sm:flex'
                }`}
            >
              <div className="mb-2">
                <Image src={item.icon} alt="Icon" className="lg:w-[159px] md:w-[130px] w-[88px] h-full" />
              </div>
              <div className="text-sm md:text-base lg:text-xl leading-snug">{item.text}</div>
            </div>
          ))}
        </div>
      </div>
