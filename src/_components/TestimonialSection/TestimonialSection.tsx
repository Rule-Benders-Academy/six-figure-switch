  ...
  return (
    <section className="bg-gradient-to-b from-[#141314] to-[#272526] text-white pt-6 pb-10 md:py-14 lg:py-20 px-4">
      <div className="sm:px-8 md:px-16 lg:px-48 flex flex-col lg:flex-row items-center gap-5 md:gap-8 lg:gap-10 w-[90%] lg:w-[90%] mx-auto ">
        ...
        >
          <h3 className="text-2xl md:text-[44px] lg:leading-[100%]">
            Real Stories,
          ...
          <h4 className="font-bold text-base md:text-[44px] mb-1">
            {name.toUpperCase()}
          </h4>
          <p className="text-base md:text-[24px] md:mt-4 font-light">
            {description}
          </p>
          <GradientButton className="!text-sm md:!text-xl lg:!text-[24px] !py-[12px] !px-5 md:!px-8 lg:!px-[35px] max-w-[503px] hidden md:block">
